...
//参考:https://magnaga.com/2016/04/25/unity-save2/
...
public class SaveData
{
    ...
    public static void Init()
    {
        ...
        savedatabase = new SaveDataBase[5];

        savedatabase[0] = new SaveDataBase(pass, "config.dat");
        savedatabase[1] = new SaveDataBase(pass, "savedata1.dat");
        savedatabase[2] = new SaveDataBase(pass, "savedata2.dat");
        savedatabase[3] = new SaveDataBase(pass, "savedata3.dat");
        savedatabase[4] = new SaveDataBase(pass, "savedata4.dat");
    ...
    private static SaveDataBase Savedatabase(int slot)
	{
        return savedatabase[Mathf.Clamp(slot,0,4)];
	...
	public static void SetList<T>(string key, List<T> list, int slot)
	{
		Savedatabase(slot).SetList<T>(key, list);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static List<T> GetList<T>(string key, List<T> _default, int slot)
	{
		return Savedatabase(slot).GetList<T>(key, _default);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static T GetClass<T>(string key, T _default,int slot) where T : class, new()
	{
		return Savedatabase(slot).GetClass(key, _default);
	...
	/// <exception cref="System.ArgumentException"></exception>
	public static void SetClass<T>(string key, T obj, int slot) where T : class, new()
	{
        Savedatabase(slot).SetClass<T>(key, obj);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	public static void SetString(string key, string value, int slot)
	{
        Savedatabase(slot).SetString(key, value);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static string GetString(string key, string _default, int slot)
	{
		return Savedatabase(slot).GetString(key, _default);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	public static void SetInt(string key, int value, int slot)
	{
        Savedatabase(slot).SetInt(key, value);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static int GetInt(string key, int _default, int slot)
	{
		return Savedatabase(slot).GetInt(key, _default);
	}
	...
	/// <param name="value">デフォルトの値</param>
	/// <exception cref="System.ArgumentException"></exception>
	public static void SetFloat(string key, float value, int slot)
	{
        Savedatabase(slot).SetFloat(key, value);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static float GetFloat(string key, float _default, int slot)
	{
		return Savedatabase(slot).GetFloat(key, _default);
	}
	...
	/// <param name="key">キー</param>
	/// <exception cref="System.ArgumentException"></exception>
	public static void Remove(string key, int slot)
	{
        Savedatabase(slot).Remove(key);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static bool ContainsKey(string _key, int slot)
	{
		return Savedatabase(slot).ContainsKey(_key);
	}
	...
	/// <exception cref="System.ArgumentException"></exception>
	/// <returns></returns>
	public static List<string> Keys(int slot)
	{
		return Savedatabase(slot).Keys();
	}
    ...
    private static SaveDataBase Savedatabase
    {
        get
        {
            if (savedatabase == null)
            {
                ...
                string fileName = Application.productName + "_.dat";
